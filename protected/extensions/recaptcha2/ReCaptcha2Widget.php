...
class ReCaptcha2Widget extends CInputWidget {
    ...
    public function run() {
        ...
        if($this->hasModel() AND $this->model->hasErrors($this->attribute)) {
            $this->wrapperOptions['class'] = isset($this->wrapperOptions['class']) ? $this->wrapperOptions['class'] . " ". $this->errorClass : $this->errorClass;
        }
