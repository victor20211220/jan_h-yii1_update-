...
$cron_jobs = array(
    ...
    array(
        "period"=>"0 0 * * *",
        "script"=>"premiumchecker.php",
    ),
    array(
        "period"=>"0 0 * * 0",
        "script"=>"linkcalculator.php",
    ),
);
...
<html lang="en">
<head>
<title>Web Catalog | Command Builder</title>
</head>
<body>
<p>
    Below you can find a list of cron jobs you need to setup.
    <a href="https://docs.php8developer.com/web-catalog/#/installation?id=cron-jobs" target="_blank">Read here</a> how you can do it.
</p>
<ul>
