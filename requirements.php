...
<head>
    ...
    <title>Web Catalog | Requirements</title>
    <style type="text/css">
        body
        {
            background: white;
...
<div id="page">
    ...
    <div id="content">
        ...
        <p>
            ...
            for running <a href="http://catalog.php8developer.com">Web Catalog</a>.
        ...
        <p>
            <?php if($result>0): ?>
                Congratulations! Your server configuration satisfies minimum requirements by Web Catalog.
            <?php else: ?>
                Unfortunately your server configuration does not satisfy the requirements by Web Catalog.
            <?php endif; ?>
        </p>
